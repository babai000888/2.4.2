...
<form action="#" th:action="editUser"  method="post" >
    <table>
        <tbody>
        <tr>
            <td>ID:</td>
        ...
        <tr>
            <td>NAME(login):</td>
            <td>
                <input type="text" placeholder="${user.name}" th:field="${user.name}" />
            </td>
        </tr>
        <tr>
            <td>password:</td>
            <td>
                <input type="text" placeholder="${user.password}" th:field="${user.password}" />
            </td>
        </tr>
        <tr>
            <td>LAST NAME</td>
            <td>
                <input type="text" placeholder="${user.lastName}" th:field="${user.lastName}" />
            </td>
        </tr>
        <tr>
            <td>AGE</td>
            <td>
                <input type="text" placeholder="${user.age}" th:field="${user.age}" />
            </td>
        </tr>
        <tr>
            <td>Select roles: </td>
